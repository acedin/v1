...
<head>
    ...
    <script type="text/javascript">
        function popjack() {
            window.open('http://slozzo.com/termsandcondition.html', 'popjack', 'toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=no,copyhistory=no,scrollbars=yes,width=640,height=480');
        }
...
<div id="main_bg">
                                                        ...
                                                        <table width="700" align="center" border="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td class="requiredfield" align="right"><input
                                                                        ...
                                                                        value="SUBMIT ORDER" name="submit"></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                        <br>
    ...
    <div style="text-align: center" class="footer">
        <p>Copyright &copy; 2016. VitoSlim	</p>
        <p></p>
    </div>
